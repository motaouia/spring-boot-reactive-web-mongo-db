package org.medmota.reactivedemo.controllers;

import org.medmota.reactivedemo.entities.Contact;
import org.medmota.reactivedemo.repositories.ContactRepository;
...
public class ContactController {
	...
	public Mono<ResponseEntity<Contact>> getContactById(@PathVariable String id) {
		return this.contactRepository.findById(id).map(contact -> new ResponseEntity<>(contact, HttpStatus.OK))
